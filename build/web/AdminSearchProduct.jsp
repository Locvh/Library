                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 mx-auto text-center mb-5 section-heading">
                            ...
                            <h2 class="mb-5">Nhập tên sản phẩm để tìm kiếm</h2>
                        </div>
                    </div>
                            ...
                            <form action="AdminController" method="POST" class="p-5 bg-white">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12 mb-3 mb-md-0">
                                        <label class="font-weight-bold" for="name">Nhập tên sản phẩm</label>
                                        <input type="text" name="txtSearchProduct" value="${requestScope.search}" class="form-control" autocomplete="off" placeholder="Nhập tên sản phẩm" />                    
                                    </div>
                                </div>

                                <div class="row form-group">                              
                                    <div class="col-md-12" >
                                        <input type="submit" name="action" value="Search Product" class="register-button mt-0" style="margin-left: 160px">
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <c:if test="${requestScope.INFO_SEARCH_PRODUCT_ADMIN != null}">
                      <c:set var="info" value = "${requestScope.INFO_SEARCH_PRODUCT_ADMIN}"/>
                        <c:if test="${not empty requestScope.INFO_SEARCH_PRODUCT_ADMIN}" var="checkData">           
                                ...
                                <tbody>
                                    <c:forEach var="dto" items="${info}" varStatus="counter">
                                        <tr>
                                            <td>${counter.count}</td>
                                            <td>${dto.productId}</td>
                                            <td> <img src="images/${dto.image}" width="250" height="250"/></td>
                                            ...
                                            <td>
                                                <c:url var="deleteLink" value="AdminController">
                                                    ...
                                                    <c:param name="txtSearchProduct" value="${param.productName}"/>
                                                    <c:param name="action" value="Delete Product" />
                                                </c:url>
