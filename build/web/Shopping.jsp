                            ...
                            <div class="col-lg-9 col-md-8">
                                <div class="header-top-right">
                                    <ul class="ht-menu">
                                        ...
                                        <li><a href="ShoppingCart.jsp"><img src="images/cart.png" style="width: 27px; height: 27px"/></a></li>                                       
                ...
                <div class="container">
                    <div class="breadcrumb-content">
                        <ul>
                            ...
                            <li class="active">Thuê sách thư viện Limupa</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="single-banner shop-page-banner">
                                <a href="#">
                                    <img src="images/tet.jpg" alt="Li's Static Banner">
                                </a>
                            </div>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="grid-view" class="tab-pane fade active show" role="tabpanel">
                                        <div class="product-area shop-product-area">
                                            ...
                                            <div class="row">
                                                <c:forEach  items="${requestScope.INFO}" var="product">
                                                    <div class="col-lg-3 col-md-4 col-sm-6 mt-40">                                                    
                                                        <div class="single-product-wrap">
                                                            <div class="product-image">
                                                                <a href="#">
                                                                    <img src="images/${product.image}" width="200" height="200" alt="Li's Product Image"/> <br/>
                                                                </a>
                                                            </div>
                                                                ...
                                                                <div class="product_desc_info">
                                                                    <div class="product-review">
                                                                        <h5 class="manufacturer">
                                                                            <div>Mã số sản phẩm: #${product.productId}</div>
                                                                        </h5>
                                                                    ...
                                                                    <div class="price-box">
                                                                        <span class="new-price">Tiền: ${product.price}VND</span> <br>
                                                                        <span class="new-price">số lượng: ${product.quantity}</span>   
                                    ...
                                    <div class="paginatoin-area">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6">
                                                <p>Showing 1-3 of the item(s)</p>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <ul class="pagination-box">
                                                    <c:forEach begin="1" end="${requestScope.ENDPAGE}" var="i">
                                                        <a class="page-item" href="ProductController?index=${i}">${i}</a>
                                                    </c:forEach>
                                                </ul>
                                            </div>
                                        </div>
        ...
        <!--        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
                <script>
                                function loadMore() {
                                    ...
                                    $.ajax({
                                        url: "/LunarNewYear_/ProductController",
