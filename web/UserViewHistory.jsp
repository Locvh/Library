                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="hb-menu">
                                    <nav>
                                        <ul>
                                            <li class="dropdown-holder"><a href="UserController?action=View History">Lịch sử thuê sách</a></li>
                                            <li class="dropdown-holder"><a href="UserUpdateProfile.jsp">Cập nhật hồ sơ</a></li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 mx-auto text-center mb-5 section-heading">
                            <h1 class="mb-5">Xin chào, ${sessionScope.USER}</h1>
                            <h2 class="mb-5">Mời bạn xem lại lịch sử sách đã thuê</h2>
                        </div>
                    </div>
                    <c:if test="${requestScope.LIST_USER_ORDER != null}">
                        <c:set var="info" value = "${requestScope.LIST_USER_ORDER}"/>
                        <c:if test="${not empty requestScope.LIST_USER_ORDER}" var="checkData">
                                ...
                                <table border="1" id="myTable" class="tablesorter" style="width:100%; text-align: center" >
                                    <thead style="text-align: center">
                                        <tr>
                                            ...
                                            <th>Số điện thoại </th>
                                            <th>Địa chỉ</th>
                                            <th>Tổng tiền sách thuê</th>                                            
                                            <th>Chi tiết sách đã thuê</th>                                            
                                            <!--<th>Huỷ đơn hàng</th>-->
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach var="dto" items="${info}" varStatus="counter">
                                            <tr>
                                                ...
                                                <td> 
                                                    <c:url var="viewDetailLink" value="UserController">
                                                        <c:param name="txtOrderId" value="${dto.oderId}"/>
                                                        <c:param name="action" value="View Detail" />                                
                                                    </c:url>
...
<!--                                                <td>
                                                    <c:url var="deleteLink" value="UserController">
                                                        <c:param name="txtOrderId" value="${dto.oderId}"/>
                                                        <c:param name="action" value="Delete History" />    
                                                    </c:url>
                    ...
                    <c:if test="${requestScope.LIST_ORDER_DETAIL != null}">
                        <c:set var="info" value = "${requestScope.LIST_ORDER_DETAIL}"/>
                        <c:if test="${not empty requestScope.LIST_ORDER_DETAIL}" var="checkData">
