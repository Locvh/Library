             ...
             <div class="breadcrumb-area">
                <div class="container">
                    <div class="breadcrumb-content">
                        <ul>
                            <li><a href="AdminSearchProduct.jsp">Home</a></li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 mx-auto text-center mb-5 section-heading">
                            <h2 class="mb-5">Cập nhật thông tin sản phẩm</h2>
                        </div>
                    </div>
...
<!--                                <img src="images/${requestScope.DTO.image}" width="250" height="250" style="margin-left: 135px"/> <br/>                                                                                     

                                -->                                <div class="row form-group">
                                    <div class="col-md-12 mb-3 mb-md-0">
                                        <label class="font-weight-bold" for="productId">Mã sản phẩm</label>
                                        <input type="text" name="txtProductId" value="${requestScope.DTO.productId}" class="form-control" placeholder="Mã sản phẩm" readonly>
                                    </div>
                                </div>                                
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12 mb-3 mb-md-0">
                                        ...
                                        <input type="text" name="txtProductName" value="${requestScope.DTO.productName}" class="form-control" placeholder="Tên sản phẩm">
                                    </div>
                                </div>
                                <font color="red">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12 mb-3 mb-md-0">
                                        ...
                                        <input type="text" name="txtDescription" value="${requestScope.DTO.description}" class="form-control" placeholder="Mô tả">
                                    </div>
                                </div>   
                                <font color="red">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12 mb-3 mb-md-0">
                                        ...
                                        <input type="text" name="txtPrice" value="${requestScope.DTO.price}" class="form-control" placeholder="Số người tối đa">
                                    </div>
                                </div>   
                                <font color="red">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12 mb-3 mb-md-0">
                                        ...
                                        <input type="text" name="txtQuantity" value="${requestScope.DTO.quantity}" class="form-control" placeholder="Số người tối đa">
                                    </div>
                                </div>   
                                <font color="red">
                                ...
                                <div class="row form-group">                              
                                    <div class="col-md-12" >
                                        ...
                                        <input type="submit" name="action" value="Update Product" class="register-button mt-0" style="margin-left: 160px">
                                    </div>
                                </div>
                            </form>      
                        </div>
