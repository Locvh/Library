            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 mx-auto text-center mb-5 section-heading">
                        ...
                        <h2 class="mb-5">Mời bạn xem lại lịch sự thuê sách của khách hàng</h2>
                    </div>
                </div>
                    ...
                    <div class="col-md-12 col-lg-8 mb-5">
                        <form action="AdminController" method="POST" class="p-5 bg-white">
                            <div class="row form-group">                              
                                <div class="col-md-12" >
                                <input type="submit" name="action" value="Load History" class="register-button mt-0" style="margin-left: 160px">
                            </div>
                            </div>
                        </form>
                    </div>
                ...
                <c:if test="${requestScope.INFO_HISTORY != null}">
                    <c:set var="info" value = "${requestScope.INFO_HISTORY}"/>
                    <c:if test="${not empty requestScope.INFO_HISTORY}" var="checkData">
                                ...
                                <tbody>
                                    <c:forEach var="dto" items="${info}" varStatus="counter">
                                        <tr>
                                            ...
                                            <td> 
                                                <c:url var="viewDetailLink" value="AdminController">
