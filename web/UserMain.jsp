<%-- 
    Document   : index
    Created on : Feb 4, 2021, 1:10:18 AM
    Author     : LocVH
--%>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <a href="#">
                                <img src="images/tet21.jpg" width="1170px">
                            </a>
                            <!-- Li's Static Home Image Area End Here -->
                            <!-- Begin Li's Static Home Content Area -->
                            <div class="li-static-home-content">
                                <h2>Ngày tết an lành</h2>
                                <h3>Chúc mừng năm mới <span>2021</span></h3>                              
                                <div class="default-btn">
                                    <a href="UserController?action=Shopping" class="links">Shopping Now</a>
                                </div>
                            </div>
