                                        ...
                                        <ul>
                                            <li class="dropdown-holder"><a href="AdminMain.jsp">Home</a>
                                                <ul class="hb-dropdown">
                                                    ...
                                                    <li><a href="AdminController?action=category">Tạo danh mục</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </nav>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="li-static-home-content">
                                <font color="white"> <h2>Thư viện Limupa<span> 2023</span></h2></font>                               
                                <div class="default-btn">
                                    <a href="UserController?action=Shopping" class="links">Thuê sách</a>
                                </div>
                            </div>
